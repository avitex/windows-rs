    ...
    pub mod Win32 {
        ...
        pub mod System {
            ...
            pub mod Com {
                ...
                impl HRESULT {}
                impl ::std::default::Default for HRESULT {
                    fn default() -> Self {
                        Self(0)
                    }
                }
                ...
                impl ::std::fmt::Debug for HRESULT {
                    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        fmt.debug_struct("HRESULT")
                            .field("Value", &format_args!("{:?}", self.0))
                            .finish()
                    }
                }
                impl ::std::cmp::PartialEq for HRESULT {
                    fn eq(&self, other: &Self) -> bool {
                        self.0 == other.0
                    }
                }
                impl ::std::cmp::Eq for HRESULT {}
                unsafe impl ::windows::Abi for HRESULT {
                    type Abi = Self;
                }
                pub unsafe fn CoCreateGuid(pguid: *mut ::windows::Guid) -> HRESULT {
                    #[link(name = "OLE32")]
                    extern "system" {
                        pub fn CoCreateGuid(pguid: *mut ::windows::Guid) -> HRESULT;
                    }
                ...
                pub struct IUnknown(::windows::IUnknown);
                impl IUnknown {
                ...
                unsafe impl ::windows::Interface for IUnknown {
                    type Vtable = IUnknown_abi;
                    const IID: ::windows::Guid =
                        ::windows::Guid::from_values(0, 0, 0, [192, 0, 0, 0, 0, 0, 0, 70]);
                }
                impl ::std::convert::From<IUnknown> for ::windows::IUnknown {
                ...
                impl<'a> ::windows::IntoParam<'a, ::windows::IUnknown> for IUnknown {
                ...
                impl<'a> ::windows::IntoParam<'a, ::windows::IUnknown> for &'a IUnknown {
                    fn into_param(self) -> ::windows::Param<'a, ::windows::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<::windows::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
                ...
                pub unsafe fn CoCreateInstance<'a>(
                    ...
                    punkouter: impl ::windows::IntoParam<'a, IUnknown>,
                    dwclscontext: CLSCTX,
                    riid: *const ::windows::Guid,
                ...
                impl ::std::convert::From<IAgileObject> for IUnknown {
                    fn from(value: IAgileObject) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, IUnknown> for IAgileObject {
                    fn into_param(self) -> ::windows::Param<'a, IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<IUnknown>::into(self))
                    }
                }
                impl<'a> ::windows::IntoParam<'a, IUnknown> for &'a IAgileObject {
                    fn into_param(self) -> ::windows::Param<'a, IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
                    }
                }
            ...
            pub mod OleAutomation {
                ...
                impl IErrorInfo {
                    ...
                    pub unsafe fn GetSource(&self, pbstrsource: *mut BSTR) -> super::Com::HRESULT {
                ...
                impl ::std::convert::From<IErrorInfo> for super::Com::IUnknown {
                    fn from(value: IErrorInfo) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for IErrorInfo {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            self,
                        ))
                    }
                }
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for &'a IErrorInfo {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
            ...
            pub mod SystemServices {
                ...
                impl ::std::fmt::Debug for PSTR {
                    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        fmt.debug_struct("PSTR")
                            .field("Value", &format_args!("{:?}", self.0))
                            .finish()
                    }
                }
                ...
                pub const CO_E_NOTINITIALIZED: super::Com::HRESULT =
                    super::Com::HRESULT(-2147221008i32 as _);
                pub const E_POINTER: super::Com::HRESULT = super::Com::HRESULT(-2147467261i32 as _);
            }
            #[allow(
                unused_variables,
                non_upper_case_globals,
            ...
            pub mod WinRT {
                ...
                impl ::std::convert::From<IRestrictedErrorInfo> for super::Com::IUnknown {
                    fn from(value: IRestrictedErrorInfo) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for IRestrictedErrorInfo {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            self,
                        ))
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for &'a IRestrictedErrorInfo {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
                ...
                impl ILanguageExceptionErrorInfo {
                    ...
                    pub unsafe fn GetLanguageException(
                        &self,
                        languageexception: *mut ::std::option::Option<super::Com::IUnknown>,
                    ) -> super::Com::HRESULT {
                        (::windows::Interface::vtable(self).6)(
                            ::windows::Abi::abi(self),
                ...
                impl ::std::convert::From<ILanguageExceptionErrorInfo> for super::Com::IUnknown {
                    fn from(value: ILanguageExceptionErrorInfo) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for ILanguageExceptionErrorInfo {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            self,
                        ))
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for &'a ILanguageExceptionErrorInfo {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
                ...
                impl ILanguageExceptionErrorInfo2 {
                    ...
                    pub unsafe fn CapturePropagationContext<'a>(
                        &self,
                        languageexception: impl ::windows::IntoParam<'a, super::Com::IUnknown>,
                    ) -> super::Com::HRESULT {
                        (::windows::Interface::vtable(self).8)(
                            ::windows::Abi::abi(self),
                ...
                impl ::std::convert::From<ILanguageExceptionErrorInfo2> for super::Com::IUnknown {
                    fn from(value: ILanguageExceptionErrorInfo2) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for ILanguageExceptionErrorInfo2 {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            self,
                        ))
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for &'a ILanguageExceptionErrorInfo2 {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
                ...
                impl ::std::convert::From<IWeakReference> for super::Com::IUnknown {
                    fn from(value: IWeakReference) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for IWeakReference {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            self,
                        ))
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for &'a IWeakReference {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
                ...
                impl ::std::convert::From<IWeakReferenceSource> for super::Com::IUnknown {
                    fn from(value: IWeakReferenceSource) -> Self {
                        unsafe { ::std::mem::transmute(value) }
                    }
                }
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for IWeakReferenceSource {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            self,
                        ))
                ...
                impl<'a> ::windows::IntoParam<'a, super::Com::IUnknown> for &'a IWeakReferenceSource {
                    fn into_param(self) -> ::windows::Param<'a, super::Com::IUnknown> {
                        ::windows::Param::Owned(::std::convert::Into::<super::Com::IUnknown>::into(
                            ::std::clone::Clone::clone(self),
                        ))
